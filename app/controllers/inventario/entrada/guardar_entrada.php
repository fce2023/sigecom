...
try {
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $query = "INSERT INTO detalle_producto_proveedor (ID_proveedor, ID_producto, Fecha_abastecimiento, cantidad, Observación, Estado) 
                  VALUES (:id_proveedor, :id_producto, :fecha_abastecimiento, :cantidad, :observacion, 1)";
