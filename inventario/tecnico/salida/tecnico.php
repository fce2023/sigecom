                ...
                <div class="row">
                        <div class="col-xs-12">
                            <div class="form-group label-floating">
                                ...
                                <select class="form-control" name="tecnico-reg" id="listaTecnicos" required title="Seleccione un técnico." onchange="filtrarClientesPorTecnico(this.value)">
                                    ...
                                    <?php
                                    if ($rol_sesion == 'tecnico') {
                                        $query = "SELECT t.ID_tecnico, p.nombre FROM tecnico t INNER JOIN personal p ON t.id_personal = p.ID_personal WHERE t.ID_usuario = $id_usuario_sesion ORDER BY p.nombre";
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group label-floating">
                                ...
                                <select class="form-control" name="tipo-reg" required title="Seleccione un tipo de movimiento.">
                                    <option value="">Seleccione una opción</option>
