...
<div class="container-fluid">
    <div class="panel panel-danger">
        ...
        <div class="panel-body">
            <form action="<?php echo $URL; ?>/app/controllers/proveedor/crear.php" method="post" style="background-color: #E0E0E0; padding: 15px; border-radius: 10px; box-shadow: 0px 0px 10px rgba(0,0,0,0.2);">
                <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <div class="form-group label-floating">
                                    ...
                                    <input id="nombre-proveedor" class="form-control" type="text" name="nombre-proveedor" required="" maxlength="10">
                                </div>
                            </div>
                            <div class="col-xs-12">
                                <div class="form-group label-floating">
                                    <label class="control-label" style="color: #2196F3;">Dirección del Proveedor *</label>
                                    <input id="direccion-proveedor" class="form-control" type="text" name="direccion-proveedor" required="" maxlength="100">
                                </div>
                            </div>
                            <div class="col-xs-12">
                                <div class="form-group label-floating">
                                    <label class="control-label" style="color: #2196F3;">Teléfono del Proveedor *</label>
                                    <input id="telefono-proveedor" class="form-control" type="text" name="telefono-proveedor" required="" maxlength="100">
                                </div>
                            </div>
                            <div class="col-xs-12">
                                <div class="form-group label-floating">
                                    <label class="control-label" style="color: #2196F3;">Estado del Proveedor</label>
                                    <select class="form-control" name="estado-proveedor">
